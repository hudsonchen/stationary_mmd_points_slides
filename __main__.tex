...
\begin{frame}{Existing work}
    ...
    \end{itemize}
    \begin{answer box}
        {\centering\textbf{Three limitations}\par}
        \begin{itemize}
...
\begin{frame}{Experiments}
    ...
    \end{itemize}
    \vspace{0.2cm}
    \centering \includegraphics[width=\linewidth,keepaspectratio]{figures/mog.pdf}
    \vspace{-0.2cm}
    \begin{itemize}
